...
class MapLoader:
    ...
    def load(self,index_path):
        ...
        for entry in index.get("maps",[]):
            ...
            map.map_def.map_width = entry.get(
                "width",
                1
            )

            map.map_def.map_height = entry.get(
                "height",
                1
            )
            ...
            map.camera_follow_x = entry.get(
                "camera_follow_x",
                False
            )

            map.camera_follow_y = entry.get(
                "camera_follow_y",
                False
            )

            map.wrap_x = entry.get(
                "wrap_x",
                False
            )

            map.wrap_y = entry.get(
                "wrap_y",
                False
            )

            map.world_x = entry.get(
                "world_x",
                0
            )

            map.world_y = entry.get(
                "world_y",
                0
            )
