...
class SizeBarManager:
    ...
    def draw(self):
        ...
        print(f"Time elapsed: {minutes}:{seconds}; Player Life State: {self.player.life_state.get_state()}")


        self.window.blit(time_surface, (10,50))
        self.window.blit(size_surface, (10,80))
        self.window.blit(level_surface, (10,110))
