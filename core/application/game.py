...
class Game:
    ...
    def handle_event(self, event):
        ...
        if (
            self.game_object.tutorial_state is not None
            and self.game_object.tutorial_state.is_state(TUTORIALSTATE.WIN)
        ):
    ...
    def update(self):
        ...
        if (
            self.game_object.tutorial_state
            and self.game_object.tutorial_state.is_state(TUTORIALSTATE.WIN)
        ):
    ...
    def set_game_mode(self, mode=None):
        ...
        if mode:
            ...
            self.game_mode.set_state(
                self.game_object.endless_state
            )
