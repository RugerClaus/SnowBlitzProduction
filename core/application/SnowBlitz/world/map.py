...
class Map:
    ...
    def update_cell_colors(self):
        ...
        for cell in self.cells:
            ...
            color = tuple(int(channel * light) for channel in base_color)
    ...
    def draw(self, camera=None):
        ...
        if self.wrap_x:
            # Normalize the map position into one cycle.
            ...
            # Fixed/infinite-space map: draw exactly once.
        ...
        for x in x_positions:
            for y in y_positions:
                ...
                # Don't bother drawing completely off-screen copies.
                if x + layer_width < 0:
                    continue
    ...
    def render_debug_grid(self):
        ...
        for column in range(self.columns + 1):
            ...
            self.system.window.draw_line(self.layer_surface,(x,0),(x,wh),color,width)

        for row in range(self.rows + 1):
            y = round(row * wh / self.rows)
            self.system.window.draw_line(self.layer_surface,(0,y),(ww,y),color,width)
