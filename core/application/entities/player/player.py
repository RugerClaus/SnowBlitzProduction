...
class Player(Entity):
    ...
    def update(self):
        ...
        self.powerup_duration = physics.calculate_powerup_duration(
            self.score
        )
        ...
        if self.system.control_state.is_state(DEVELOPER_MODE.ON):
            ...
            self.shrink_rate = physics.calculate_shrink_rate(
                self.diam,
                self,
                self.environment
            )
    ...
    def reset(self):
        ...
        self.level_up_size = physics.calculate_level_up_size(
            self.current_level
        )
