...
class MenuStateManager(BaseStateManager):
    def __init__(self):
        ...
        allowed_transitions = {
            ...
            MENUSTATE.CREATEUSERNAME: [MENUSTATE.ROOT,MENUSTATE.LOGIN],
            MENUSTATE.ROOT: [MENUSTATE.SETTINGS,MENUSTATE.CREDITS,MENUSTATE.LEADERBOARDOPTIN,MENUSTATE.LEADERBOARDVIEWER,MENUSTATE.CHANGELOG],
            MENUSTATE.LEADERBOARDVIEWER: [MENUSTATE.ROOT],
            MENUSTATE.SETTINGS: [MENUSTATE.ROOT,MENUSTATE.AUDIO,MENUSTATE.DEVELOPERSETTINGS,MENUSTATE.LOGIN],
            ...
            MENUSTATE.CHANGELOG: [MENUSTATE.ROOT],
            MENUSTATE.LOGIN: [MENUSTATE.ROOT]
