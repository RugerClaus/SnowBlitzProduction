...
class LoadingStateManager(BaseStateManager):
    def __init__(self):
        ...
        allowed_transitions = {
            LOAD_SCREEN_STATE.NONE: [LOAD_SCREEN_STATE.STUDIO_SPLASH_SCREEN],
            LOAD_SCREEN_STATE.STUDIO_SPLASH_SCREEN: [LOAD_SCREEN_STATE.NONE],
        }

        super().__init__(
                initial_state=LOAD_SCREEN_STATE.STUDIO_SPLASH_SCREEN,
