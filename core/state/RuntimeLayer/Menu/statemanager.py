...
class MenuStateManager(BaseStateManager):
    def __init__(self):
        ...
        allowed_transitions = {
            MENUSTATE.CREATEUSERNAME: [MENUSTATE.ROOT,MENUSTATE.CHANGELOG,MENUSTATE.LOGIN],
            MENUSTATE.ROOT: [MENUSTATE.SETTINGS,MENUSTATE.CREDITS,MENUSTATE.CHANGELOG,MENUSTATE.CREATEUSERNAME,MENUSTATE.LEADERBOARDVIEWER],
