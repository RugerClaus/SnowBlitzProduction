...
class BootSplashStateManager(BaseStateManager):
    def __init__(self):
        ...
        allowed_transitions = {
            BOOT_SPLASH_STATE.NONE: [BOOT_SPLASH_STATE.BOOT_SPLASH_SCREEN_ONE,BOOT_SPLASH_STATE.BOOT_SPLASH_SCREEN_TWO],
            BOOT_SPLASH_STATE.BOOT_SPLASH_SCREEN_ONE: [BOOT_SPLASH_STATE.NONE,BOOT_SPLASH_STATE.BOOT_SPLASH_SCREEN_TWO],
            BOOT_SPLASH_STATE.BOOT_SPLASH_SCREEN_TWO: [BOOT_SPLASH_STATE.NONE]
        }
